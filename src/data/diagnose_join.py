...
# Proyecto + modelo reales de los motores que tienen muestras de aceite
show("Proyecto/Modelo de los motores con aceite (MOTOR)", """
    SELECT mp.Name AS proyecto, ef.Model AS modelo, COUNT(DISTINCT ld.MiningEquipmentId) AS motores,
           COUNT(*) AS muestras
...
# Valores exactos de Proyecto/MODELO en lc para COMPONENTE=MOTOR
