...
# 1. Valores de COMPONENTE/MODELO/TIPO en lc (para ubicar el MOTOR)
...
# 2. ¿Qué columnas de LaboratoryData identifican proyecto/modelo/componente?
...
# 3. ¿Hay una vista/tabla que ya una equipo->proyecto->modelo?
...
# 4. Columnas de MiningProject y EquipmentFleet (para sacar nombre de mina/modelo)
from sqlalchemy import inspect
insp = inspect(eng)
for sch,t in [("Mine","MiningProject"),("Mine","EquipmentFleet")]:
    print(f"\n=== {sch}.{t} ===")
    for c in insp.get_columns(t, schema=sch): print(" ", c["name"], c["type"])